/* datafolia.com.br — cookie consent banner + Google Consent Mode v2 (GDPR/LGPD)
 * Standalone, no dependencies. Stores choice in localStorage as 'df-consent' = 'granted' | 'denied'.
 */
(function () {
  'use strict';
  var KEY = 'df-consent';
  ...
  function init() {
    ...
    banner.addEventListener('click', function (e) {
      ...
      document.dispatchEvent(new CustomEvent('df:consent', { detail: { value: action } }));
    });
  }
