...
- **Eleitores aptos a votar em cada eleição (milhões)** (4 pontos, 2018-2024)
  Fonte: [TSE — Tribunal Superior Eleitoral](https://www.tse.jus.br/eleicoes/estatisticas)

- **Interesse no Google por 'Kely' no Brasil — proxy do nome (escala 0–100)** (4 pontos, 2018-2024)
  Fonte: [Google Trends (pytrends)](https://trends.google.com/trends/explore?geo=BR&q=Kely)
